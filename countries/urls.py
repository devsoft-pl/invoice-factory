...
from countries.views import (create_country_ajax_view, create_country_view,
                             delete_country_view, list_countries_view,
...
urlpatterns = [
    ...
    path("create_ajax/", create_country_ajax_view, name="create_country_ajax"),
